...
public interface ResultadoRepository extends JpaRepository<Resultado, Long> {
    ...
    List<Resultado> findByCategoria(Categoria categoria);

    List<Resultado> findByClassificacao(Classificacao classificacao);

    List<Resultado> findByEndereco(Endereco endereco);
